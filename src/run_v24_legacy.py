"""V24 Coordinated Edward+Salah audit — Legacy SM set (pre-1999, sequential)."""
...
OUTPUT_FILE = os.path.join(BASE, "Salah", "legacy", "SM_V24_EDWARD_SALAH_LEGACY.csv")
PROGRESS_FILE = os.path.join(BASE, "legacy_v24_progress.jsonl")
...
def main():
    ...
    print(f"V24 Coordinated Audit — Legacy SM (n={len(df)}), resuming from {start_index}", flush=True)
