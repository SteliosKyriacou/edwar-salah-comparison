"""V25 Multi-Agent Pipeline — Legacy SM set (N=175)."""
...
OUTPUT_FILE = os.path.join(BASE, "Validation", "legacy", "SM_V25_EDWARD_SALAH_LEGACY.csv")
PROGRESS_FILE = os.path.join(BASE, "legacy_v25_progress.jsonl")
...
def main():
    ...
    print(f"V25 Multi-Agent Pipeline — Legacy SM (n={len(df)}), resuming from {start_index}", flush=True)
