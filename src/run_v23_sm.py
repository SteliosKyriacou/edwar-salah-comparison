"""V23 Coordinated Edward+Salah audit — Modern SM set (sequential, production quality)."""
...
OUTPUT_FILE = os.path.join(BASE, "Salah", "modern", "SM_V23_EDWARD_SALAH.csv")
PROGRESS_FILE = os.path.join(BASE, "sm_v23_progress.jsonl")
...
def main():
    ...
    print(f"V23 Coordinated Audit — Modern SM (n={len(df)}), resuming from {start_index}", flush=True)
