"""V24 Coordinated Edward+Salah audit — Modern SM set (sequential)."""
...
OUTPUT_FILE = os.path.join(BASE, "Salah", "modern", "SM_V24_EDWARD_SALAH.csv")
PROGRESS_FILE = os.path.join(BASE, "sm_v24_progress.jsonl")
...
def main():
    ...
    print(f"V24 Coordinated Audit — Modern SM (n={len(df)}), resuming from {start_index}", flush=True)
