"""V23 Coordinated Edward+Salah audit on neurodegenerative clinical candidates."""
...
OUTPUT_FILE = os.path.join(BASE, "NEURO_V23_EDWARD_SALAH.csv")
PROGRESS_FILE = os.path.join(BASE, "neuro_v23_progress.jsonl")
...
def main():
    ...
    print(f"Starting Neuro V23 Coordinated Audit from index {start_index} (n={len(df)})...", flush=True)
