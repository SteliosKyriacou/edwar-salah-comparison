"""V24 Coordinated Edward+Salah audit on 2025 drug data."""
...
OUTPUT_FILE = os.path.join(BASE, "Salah", "2025", "2025_V24_EDWARD_SALAH.csv")
PROGRESS_FILE = os.path.join(BASE, "2025_v24_progress.jsonl")
...
def main():
    ...
    print(f"Starting 2025 V24 Coordinated Audit from index {start_index} (n={len(df)})...", flush=True)
    ...
    res_df = res_df.rename(columns={
        "edward_score": "Edward Score V24",
        "rational": "Rationale V24",
        "metabolic_stability_estimate": "Metabolic Stability V24",
        "potential_toxic_fragments": "Toxic Fragments V24",
        "p1_prob": "P1 Prob V24",
        "p1_rationale": "P1 Rationale V24",
        "p2_prob": "P2 Prob V24",
        "p2_rationale": "P2 Rationale V24",
        "p3_prob": "P3 Prob V24",
        "p3_rationale": "P3 Rationale V24",
        "tcsp": "TCSP V24",
        "salah_verdict": "Salah Verdict V24",
        "biological_risk": "Biological Risk V24",
        "clinical_attrition_risk": "Clinical Attrition Risk V24",
        "target_stigma_penalty": "Target Stigma Penalty V24",
        "p3_cap_reason": "P3 Cap Reason V24",
    })
