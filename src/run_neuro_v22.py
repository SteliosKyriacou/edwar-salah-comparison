"""V22 Coordinated Edward+Salah audit on neurodegenerative clinical candidates."""
...
OUTPUT_FILE = os.path.join(BASE, "NEURO_V22_EDWARD_SALAH.csv")
PROGRESS_FILE = os.path.join(BASE, "neuro_v22_progress.jsonl")
...
def main():
    ...
    print(f"Starting Neuro V22 Coordinated Audit from index {start_index} (n={len(df)})...", flush=True)
    ...
    res_df = res_df.rename(columns={
        ...
        "tcsp": "TCSP V22",
        "salah_verdict": "Salah Verdict V22",
        "biological_risk": "Biological Risk V22",
        "clinical_attrition_risk": "Clinical Attrition Risk V22",
        "target_stigma_penalty": "Target Stigma Penalty V22",
        "p3_cap_reason": "P3 Cap Reason V22",
    })
